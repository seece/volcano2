     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] % Clipsize[Md->Pl[i].Item] == 0) Change_clip(i); else
      {
       ...
       // pistoolin ääni
       Playsample(Samp[SAMP_PISTOL], Opt->Soundvolume, 128, 0);
       // latausaika
       Md->Pl[i].Reload = 80;
       // ja tärinä
       Md->Pl[i].Shake = 10;
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] % Clipsize[Md->Pl[i].Item] == 0) Change_clip(i); else
      {
       ...
       // pistoolin ääni
       Playsample(Samp[SAMP_BIGMACHINEGUN], Opt->Soundvolume, 128, 0);
       // latausaika
       Md->Pl[i].Reload = 30;
       // ja tärinä
       Md->Pl[i].Shake = 10;
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] % Clipsize[Md->Pl[i].Item] == 0) Change_clip(i); else
      {
       ...
       Shoot(BUL_BULLETSHELL, Md->Pl[i].X, Md->Pl[i].Y, -3000+rand()%6000, -8000+rand()%1000);
       // takataka-ääni
       Playsample(Samp[SAMP_MACHINEGUN], (Opt->Soundvolume>>1), 128, 0);
       // latausaika
       Md->Pl[i].Reload = 130;
       // tärinä
       Md->Pl[i].Shake = 30;
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]])
      {
       ...
       // panoksia pois
       Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] -- ;
       Playsample(Samp[SAMP_SHOTGUN], Opt->Soundvolume, 128, 0);
       // hylsy
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] % Clipsize[Md->Pl[i].Item] == 0) Change_clip(i); else
      {
       ...
       // panoksia pois
      Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] -- ;
       Playsample(Samp[SAMP_MAGNUM], Opt->Soundvolume, 128, 0);
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] )
      {
       ...
       // panos
       Md->Pl[i].Gunfire = 30;
       Playsample(Samp[SAMP_ROCKET], Opt->Soundvolume, 128, 0);
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] % Clipsize[Md->Pl[i].Item] == 0) Change_clip(i); else
      {
       // muuten ammu
       // panoksia pois
       Playsample(Samp[SAMP_LASER], Opt->Soundvolume, 128, 0);
     ...
     if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]] % Clipsize[Md->Pl[i].Item] == 0) Change_clip(i); else
      {
       ...
       // pistoolin ääni
       Playsample(Samp[SAMP_PLASMA], Opt->Soundvolume, 96, 0);
       // latausaika
       Md->Pl[i].Reload = 80;
       // ja tärinä
       Md->Pl[i].Shake = 20;
   ...
   if (Md->Pl[i].Reload == 0) if (Md->Pl[i].Ammo[Weaponclip[Md->Pl[i].Item]]>0)
    {
     // jos lipas on lopussa niin lataa

      {
       ...
       // pistoolin ääni
       Playsample(Samp[SAMP_SNIPER], Opt->Soundvolume, 128, 0);
       // latausaika
       Md->Pl[i].Reload = 150;
       // ja tärinä
       Md->Pl[i].Shake = 5;
