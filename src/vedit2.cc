...
void Selectbotweapon()
{
    ...
    do
    {
        ...
        case ' ':
            ...
            break;
        case 'A':
            Botweapon = ITEM_PISTOL;
            break;
        case 'B':
            Botweapon = ITEM_MAGNUM;
            break;
        case 'C':
            Botweapon = ITEM_SHOTGUN;
            break;
        case 'D':
            Botweapon = ITEM_MACHINEGUN;
            break;
        case 'E':
            Botweapon = ITEM_LASERRIFLE;
            break;
        case 'F':
            Botweapon = ITEM_BAZOOKA;
            break;
        case 'G':
            Botweapon = ITEM_HMISLAUNCHER;
            break;
        case 'H':
            Botweapon = ITEM_PLASMAPISTOL;
            break;
        case 'I':
            Botweapon = ITEM_SNIPERRIFLE;
            break;
        }; // switch(Ch)
...
// jatka editdata
            ...
            case 78:
                Brush++;
                if (Brush > Maxlandpics) Brush= Maxlandpics;
                break;
            case 74:
                if (Brush)Brush--;
                break;
