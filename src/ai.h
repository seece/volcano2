...
void Bot_walk_idle(int i)
{
    ...
    if (Md->Bot[i].Ninjarope == false)
        if (Md->Bot[i].Ox>>16 == Md->Bot[i].X>>16)
            ...
            {
                Md->Bot[i].Stuck++;
                if (Md->Bot[i].Stuck>50) {
                    Md->Bot[i].Stuck = 0;
                    Md->Bot[i].S = (Md->Bot[i].S==false);
                    Md->Bot[i].Dir = Suunta(itofix(128)-Md->Bot[i].Dir);
                }
...
void Bot_use_pistol(int i)
{
    ...
    if (Md->Bot[i].Reload == 0)
    {
        ...
        if (Md->Bot[i].Ammo % Clipsize[Md->Bot[i].Item] == 0) Bot_change_clip(i);
        else
        {
            // muuten ammu
...
void Bot_attack_target(int i)
{
    ...
    if (Md->Bot[i].Visualtarget==false)
        Md->Bot[i].Forgettarget++;
    else Md->Bot[i].Forgettarget = 0;
    ...
    if (Md->Bot[i].Live)
    {
        ...
        if (Md->Bot[i].Target!=-1)
        {
            ...
            case 2:
                ...
                rnd = 6;
                {
                    for (int a = 0; a < 3; a++) Md->Bot[i].Armor[a] = 1;
                }
                break;
            case 3:
                Speed = 10;
            ...
            case 5:
                ...
                Times = 1;
                {
                    for (int a = 0; a < 3; a++) Md->Bot[i].Armor[a] = 2;
                }
                break;
            case 6:
                Speed = 1;
                    ...
                    if ((Md->Bot[i].Dir>>16) < (Md->Bot[i].Targetdir>>16)+3)
                        if (Md->Bot[i].Visualtarget)
                        {
                            ...
                            case ITEM_MACHINEGUN:
                                Bot_use_machinegun(i);
                                break;
                            case ITEM_LASERRIFLE:
                                Bot_use_laserrifle(i);
                                break;
                            case ITEM_BAZOOKA:
                                Bot_use_bazooka(i);
                                break;
                            case ITEM_HMISLAUNCHER:
                                Bot_use_homingmissilelauncher(i);
                                break;
                            case ITEM_PLASMAPISTOL:
                                Bot_use_plasmapistol(i);
                                break;
                            case ITEM_SNIPERRIFLE:
                                Bot_use_sniperrifle(i);
                                break;
